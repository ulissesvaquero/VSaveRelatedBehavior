...
/**
 * This is the model class for table "filho".
 *
 * The followings are the available columns in table 'filho':
 * @property integer $id
 ...
 */
class Filho extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, nome, id_pessoa', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Filho the static model class
	 */
